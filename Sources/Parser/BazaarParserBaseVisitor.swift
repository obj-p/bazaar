...
open class BazaarParserBaseVisitor<T>: AbstractParseTreeVisitor<T> {
	 ...
	 */
	open func visitTemplate(_ ctx: BazaarParser.TemplateContext) -> T? { return visitChildren(ctx) }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	open func visitView(_ ctx: BazaarParser.ViewContext) -> T? { return visitChildren(ctx) }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
